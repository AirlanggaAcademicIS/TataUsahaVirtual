          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse pull-left" id="navbar-collapse">
              <ul class="nav navbar-nav">
                <li class="active"><a href="<?php echo base_url(); ?>tupages">Home <span class="sr-only">(current)</span></a></li>
                <li><a href="<?php echo base_url(); ?>tupages/docs_box">Shared Documents</a></li>
                <li><a href="<?php echo base_url(); ?>tupages/log_mahasiswa">Log Mahasiswa</a></li>
              </ul>
            </div><!-- /.navbar-collapse -->
            <!-- Navbar Right Menu -->
